...
var listMenu3 = new FSMenu('listMenu3', true, 'visibility', 'visible', 'hidden');
...
//listMenu3.showDelay = 0;
//listMenu3.switchDelay = 125;
//listMenu3.hideDelay = 500;
listMenu3.cssLitClass = 'highlighted';
//listMenu3.showOnClick = 1;
...
listMenu3.animations[listMenu3.animations.length] = animFade;
listMenu3.animations[listMenu3.animations.length] = animClipDown;
listMenu3.animSpeed = 20;
...
addEvent(window, 'load', new Function('listMenu3.activateMenu("listMenu3Root", arrow)'));
...
//addEvent(window, 'load', new Function('getRef("listMenu3Root").className="menulist"'));
